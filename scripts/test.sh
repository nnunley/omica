...
packages=(vendor/micromeasure/micromeasure-odin mica/scratch mica/var mica/buffer mica/kernel mica/vm mica/compiler mica/runtime mica/external mica/dom mica/store host/source host/web)
