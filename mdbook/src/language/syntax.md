...
Symbols can quote their names, as in `:"display name"` or `:"if"`. Quoted symbols use string escapes
and can also appear in relation headings and after the dispatch colon.
